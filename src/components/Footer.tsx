...
const socialLinks: SocialLink[] = [
  { name: "LinkedIn", href: "https://www.linkedin.com/in/adzyl-jipos-287350364/", icon: LinkedInIcon },
  { name: "GitHub", href: "https://github.com/Dev-Aziii", icon: GitHubIcon },
];
        ...
        <div>
          ...
          <div className="space-y-4">
            <a
              ...
              href="mailto:adzyl.jipos@gmail.com"
            >
